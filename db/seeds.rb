...
10.times do
  User.create!(email: Faker::Internet.email, encrypted_password: Faker::BreakingBad.episode, description: Faker::ChuckNorris.fact, first_name: Faker::FunnyName.name, last_name: Faker::DrWho.catch_phrase)
end
